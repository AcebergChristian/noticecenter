...
class Leftmenu(QWidget):
    ...
    def initleftmenu(self):
        ...
        self.leftmenu_group.setStyleSheet("background-color:{};".format(static.data["leftmenu"]["bg"]))
    ...
    def initmenu(self):
        ...
        # 左侧菜单 logo
        self.leftmenu_menu_logo = QLabel()
        self.leftmenu_menu_logo.setFixedSize(static.data["leftmenu_menu_logo"]["width"],static.data["leftmenu_menu_logo"]["height"])
        self.leftmenu_menu_logo.setScaledContents(True)
        self.applogopath = QPixmap(static.data["leftmenu_menu_logo"]["picpath"])  # 替换为你的图像文件路径
        self.leftmenu_menu_logo.setPixmap(self.applogopath)
    ...
    def clickchangemenu(self):
        if self.flag == True:
            ...
            self.leftmenu_menu_logo.setScaledContents(True)
            self.applogopathm = QPixmap(static.data["leftmenu_menu_logo"]["picpathm"])  # 替换为你的图像文件路径
            self.leftmenu_menu_logo.setPixmap(self.applogopathm)
