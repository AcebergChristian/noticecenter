...
class miniQlabel(QLabel):
    def __init__(self,arg):
        super().__init__()
        self.setText(arg)
        self.setStyleSheet("color:rgb(138,138,138);font-size:14px")
        self.setFixedSize(static.data["to_btn"]["width"],static.data["to_btn"]["height"])
        self.setAlignment(Qt.AlignmentFlag.AlignCenter)
        
    def enterEvent(self, event):
        self.setStyleSheet("font-size:14px;color:rgb(38,38,38);background-color: {};border-radius:4px;".format(static.data["to_btn"]["focusbackground"]))
    
    def leaveEvent(self, event):
        self.setStyleSheet("font-size:14px;color:rgb(138,138,138);background-color: {};border-radius:4px;".format(static.data["to_btn"]["nobackground"]))
